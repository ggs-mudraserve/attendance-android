...
public final class WiFiMonitoringService_Factory implements Factory<WiFiMonitoringService> {
  ...
  public WiFiMonitoringService get() {
    return newInstance(contextProvider.get(), approvedWiFiDaoProvider.get(), attendanceRepositoryProvider.get());
  }

  public static WiFiMonitoringService_Factory create(Provider<Context> contextProvider,
      Provider<ApprovedWiFiDao> approvedWiFiDaoProvider,
      Provider<AttendanceRepository> attendanceRepositoryProvider) {
    return new WiFiMonitoringService_Factory(contextProvider, approvedWiFiDaoProvider, attendanceRepositoryProvider);
  }

  public static WiFiMonitoringService newInstance(Context context, ApprovedWiFiDao approvedWiFiDao,
      AttendanceRepository attendanceRepository) {
    return new WiFiMonitoringService(context, approvedWiFiDao, attendanceRepository);
  }
}
