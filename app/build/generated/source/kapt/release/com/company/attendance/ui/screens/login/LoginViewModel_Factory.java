...
public final class LoginViewModel_Factory implements Factory<LoginViewModel> {
  ...
  public LoginViewModel_Factory(Provider<AttendanceRepository> repositoryProvider) {
  ...
  public static LoginViewModel_Factory create(Provider<AttendanceRepository> repositoryProvider) {
    return new LoginViewModel_Factory(repositoryProvider);
  }

  public static LoginViewModel newInstance(AttendanceRepository repository) {
